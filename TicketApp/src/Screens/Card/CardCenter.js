    ...
    <View
      ...
      <ScrollView>
        ...
        <Text style={styles.cardInsideNo}>
          ...
          <Text style={styles.cardInsideDate}>{cardDetails.expiryDate.substring(2, 5)}{cardDetails.expiryDate.substring(7, 9)}</Text>
        </View>
        ...
        <View>
          ...
          <TouchableHighlight
            ...
            <View style={styles.cardCenterBtnContainerLast}>
              <View style={styles.BtnImageContainer}>
