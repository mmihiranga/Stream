...
const CardRecharge = ({route, navigation}) => {
  ...
  const handlingSubmit = () => {
    ...
    } else if (cardNumber.substring(0,1) !== '4' && cardNumber.substring(0,1) !== '5' ){
      console.log(cardNumber.substring(0,1),"sddfdsf")
      navigation.navigate('PaySuccess', {result: cardNumber});
    }else {
  ...
  return (
    <View style={{backgroundColor: '#FFFFFF', height: height, marginTop: 20}}>
